...
# x = PetFriends()
#
# _, auth_key = x.get_api_key('forsf2022@mail.ru', 'TAPXojuiu34*')
# print(_)
# print(auth_key)
# x.add_new_pet_without_photo(auth_key, name='Виктори', animal_type='двортерьер', age='4')
# pet_photo = r'tests\images\cat1.jpg'
# pet_photo = os.path.join(os.path.dirname(__file__), pet_photo)
# print(pet_photo)
# _, my_pets = x.get_list_of_pets(auth_key, "my_pets")
# pet_id = my_pets['pets'][0]['id']
# x.add_pet_photo(auth_key, pet_id, pet_photo)
